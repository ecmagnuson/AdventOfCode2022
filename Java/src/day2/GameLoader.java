...
class Game {
	...
	private static Map<String, String> win = Map.of("R", "S",
													"P", "R",
													"S", "P");
	
	private static Map<String, Integer> choicePoints = Map.of("R", 1,
															  "P", 2,
															  "S", 3);
	
	private static Map<String, String> convert = Map.of("A", "R",   "B", "P",   "C", "S", 
            											"X", "R",   "Y", "P",   "Z", "S");
...
public class GameLoader {
	...
	public static void main(String[] args) throws IOException {
		...
		List<String> lines = readLines(new File(System.getProperty("user.dir")) + "/inputs/inputDay2");
